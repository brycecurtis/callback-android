...
public class AudioHandler extends Plugin {
     ...
     */
    public void onMessage(String id, String data) {
        LOG.d(TAG, "AudioHandler.onMessage(%s, %s)", id, data);
        
        // If phone message
        if (id.equals("telephone")) {
            
            // If phone ringing, then pause playing
            if (data.equals("RINGING") || data.equals("OFFHOOK")) {
